...
def ej2():
    ...
    while True:
        ...
        if producto == 'FIN':
            print("Se ha finalizado la actualizacion del stock")
            break
        ...
        try:
            cantidad = int(cantidad)            # Excepcion por si la cantidad ingresada
        except:                                 # es con letras en lugar de numeros
            print("Error al ingresar stock")
            continue
